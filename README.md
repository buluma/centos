# CentOS Base Images
[![Build centos6](https://github.com/buluma/centos/actions/workflows/build-centos6.yml/badge.svg?branch=master)](https://github.com/buluma/centos/actions/workflows/build-centos6.yml) [![Build centos7](https://github.com/buluma/centos/actions/workflows/build-centos7.yml/badge.svg?branch=master)](https://github.com/buluma/centos/actions/workflows/build-centos7.yml) [![Build centos8](https://github.com/buluma/centos/actions/workflows/build-centos8.yml/badge.svg?branch=master)](https://github.com/buluma/centos/actions/workflows/build-centos8.yml) ![Docker Pulls](https://img.shields.io/docker/pulls/buluma/centos)
